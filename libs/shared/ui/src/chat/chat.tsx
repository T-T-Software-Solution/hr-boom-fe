...
import { ActionIcon, Avatar, Box, Button, Card, Group, Indicator, Loader, type MantineRadius, Popover, Stack, Text, Tooltip, rem, useMantineTheme } from '@mantine/core';
...
export const Chat: React.FC<ChatProps> = ({ onMinimize, allowMinimize = false, scrollableShadow = false, radius = 'lg' }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Popover.Target>
                        <Tooltip label="ตั้งค่า" withArrow>
                            <ActionIcon
                                autoContrast
                                aria-label="ตั้งค่า"
                                variant="light"
                ...
                <Text size="sm" fw={600} c="primary.0">{config.agentName} — AI Chat</Text>
                <Tooltip label="ย่อหน้าต่าง" withArrow>
                    <ActionIcon
                        autoContrast
                        ...
                        <Sender
                                        ...
                                        placeholder={(type) =>
                                            type === 'drop'
                                                ...
                                                : {
                                                    ...
                                                    title: 'อัปโหลดไฟล์',
                                                    description: 'คลิกหรือลากไฟล์มายังพื้นที่นี้เพื่ออัปโหลด',
                                                }
                                        }
                            ...
                            actions={(_, info) => {
                                ...
                                if (agent.isRequesting()) {
                                    return (
                                        <Loader color="primary" type="dots" aria-label="กำลังส่งข้อความ..." />
                                    );
                                }
