...
interface EducationLevelDetailScreenProps {
  id: string;
  modalId?: string;
}

export const EducationLevelDetailScreen: React.FC<
  EducationLevelDetailScreenProps
> = ({ id, modalId }) => {
  ...
  const handleUpdate = () => {
    router.push(`/education-level/update/${id}`);
    if (modalId) {
    ...
    <Stack gap="xs">
      <Group gap="xs" align="center">
        <Title order={1} size="h3">
          รายละเอียดตั้งค่าระดับการศึกษา{' '}
        </Title>
