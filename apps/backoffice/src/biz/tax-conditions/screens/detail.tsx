...
interface TaxConditionDetailScreenProps {
  id: string;
  modalId?: string;
}

export const TaxConditionDetailScreen: React.FC<
  TaxConditionDetailScreenProps
> = ({ id, modalId }) => {
  ...
  const handleUpdate = () => {
    router.push(`/tax-condition/update/${id}`);
    if (modalId) {
    ...
    <Stack gap="xs">
      <Group gap="xs" align="center">
        <Title order={1} size="h3">
          รายละเอียดตั้งค่าเงื่อนไขการหักภาษี{' '}
        </Title>
