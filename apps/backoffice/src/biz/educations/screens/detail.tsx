...
export const EducationDetailScreen: React.FC<EducationDetailScreenProps> = ({
  id,
  modalId,
}) => {
  ...
  const handleUpdate = () => {
    router.push(`/education/update/${id}`);
    if (modalId) {
      modals.close(modalId);
    }
  };

  const isScreenLoading = isEducationLoading;
  if (isScreenLoading) {
        ...
        <Grid gutter="md">
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Stack align="stretch" justify="center" gap="xs">
              ...
              <Box component="div" w="fit-content" className="flex-1">
                {education?.institutionGraduated ?? '-'}{' '}
              </Box>
            </Stack>
          </Grid.Col>
        </Grid>
            ...
            <Stack align="stretch" justify="center" gap="xs">
              ...
              <Box component="div" w="fit-content" className="flex-1">
                {education?.dateStart && dayjs(education?.dateStart).isValid()
                  ? dayjs(education?.dateStart).format('DD/MM/BBBB')
                  : '-'}
              </Box>
            </Stack>
          </Grid.Col>
            ...
            <Stack align="stretch" justify="center" gap="xs">
              ...
              <Box component="div" w="fit-content" className="flex-1">
                ...
                dayjs(education?.dateGraduation).isValid()
                  ? dayjs(education?.dateGraduation).format('DD/MM/BBBB')
                  : '-'}
              </Box>
            </Stack>
          </Grid.Col>
