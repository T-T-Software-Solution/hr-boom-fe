...
interface ProfessionalLicenseMainScreenProps {
  id?: string;
}

export const ProfessionalLicenseMainScreen: React.FC<
  ProfessionalLicenseMainScreenProps
> = ({ id }) => {
  ...
  const handleCreate = () => {
    ...
    modals.open({
      ...
      children: <ProfessionalLicenseCreateScreen modalId={modalId} id={id} />,
      size: 'xl',
    });
  };
