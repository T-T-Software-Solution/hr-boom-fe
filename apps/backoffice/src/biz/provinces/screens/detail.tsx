...
interface ProvinceDetailScreenProps {
  id: string;
  modalId?: string;
}

export const ProvinceDetailScreen: React.FC<ProvinceDetailScreenProps> = ({
  id,
  modalId,
}) => {
  ...
  const handleUpdate = () => {
    router.push(`/province/update/${id}`);
    if (modalId) {
