...
interface EmployeeTypeDetailScreenProps {
  id: string;
  modalId?: string;
}

export const EmployeeTypeDetailScreen: React.FC<
  EmployeeTypeDetailScreenProps
> = ({ id, modalId }) => {
  ...
  const handleUpdate = () => {
    router.push(`/employee-type/update/${id}`);
    if (modalId) {
    ...
    <Stack gap="xs">
      <Group gap="xs" align="center">
        <Title order={1} size="h3">
          รายละเอียดตั้งค่าประเภทพนักงาน{' '}
        </Title>
