...
interface BankAccountTypeDetailScreenProps {
  id: string;
  modalId?: string;
}

export const BankAccountTypeDetailScreen: React.FC<
  BankAccountTypeDetailScreenProps
> = ({ id, modalId }) => {
  ...
  const handleUpdate = () => {
    router.push(`/bank-account-type/update/${id}`);
    if (modalId) {
    ...
    <Stack gap="xs">
      <Group gap="xs" align="center">
        <Title order={1} size="h3">
          รายละเอียดตั้งค่าประเภทบัญชีธนาคาร{' '}
        </Title>
