...
interface PrefixEnDetailScreenProps {
  id: string;
  modalId?: string;
}

export const PrefixEnDetailScreen: React.FC<PrefixEnDetailScreenProps> = ({
  id,
  modalId,
}) => {
  ...
  const handleUpdate = () => {
    router.push(`/prefix-en/update/${id}`);
    if (modalId) {
    ...
    <Stack gap="xs">
      <Group gap="xs" align="center">
        <Title order={1} size="h3">
          รายละเอียดตั้งค่าคำนำหน้าชื่อEN{' '}
        </Title>
