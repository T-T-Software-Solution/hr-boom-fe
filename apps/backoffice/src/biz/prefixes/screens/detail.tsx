...
interface PrefixDetailScreenProps {
  id: string;
  modalId?: string;
}

export const PrefixDetailScreen: React.FC<PrefixDetailScreenProps> = ({
  id,
  modalId,
}) => {
