...
interface PositionStructureTypeDetailScreenProps {
  id: string;
  modalId?: string;
}

export const PositionStructureTypeDetailScreen: React.FC<
  PositionStructureTypeDetailScreenProps
> = ({ id, modalId }) => {
  ...
  const handleUpdate = () => {
    router.push(`/position-structure-type/update/${id}`);
    if (modalId) {
    ...
    <Stack gap="xs">
      <Group gap="xs" align="center">
        <Title order={1} size="h3">
          รายละเอียดตั้งค่าชนิดของตำแหน่ง{' '}
        </Title>
